...
public class AdminDetailFragment extends Fragment {
    ...
    public static AdminDetailFragment newInstance(AdminModel device, DQBaytekMachine.DQBaytekMachineListenerInterface baytekMachineListenerInterface) {
